...
export const App = () => {
  ...
  const submit = () => {
    window.gtag('event', '7204_landing_next_click', { var: 'var3' });
    setLoading(true);
    setLoading(false);
    setThx(true);
  };
  ...
  return (
    <>
      <div className={appSt.container}>
        ...
        <SliderInput
          onClick={() => {
            window.gtag('event', '7204_calc_prcnt_click', { var: 'var3' });
          }}
          block
          value={value}
          sliderValue={value}
        ...
        <PureCell
          onClick={() => {
            window.gtag('event', '7204_main_rules', { var: 'var3' });
            setShowRules(true);
          }}
        >
          <PureCell.Graphics verticalAlign="top">
        ...
        <PureCell
          onClick={() => {
            window.gtag('event', '7204_prop_faq_start_click', { var: 'var3' });
            setShowFaqs(true);
          }}
        >
          <PureCell.Graphics verticalAlign="top">
        ...
        <div className={appSt.container}>
          {faqs.map((faq, index) => (
            <div key={index}>
              <div
                onClick={() => {
                  window.gtag('event', '7204_prop_faq_click', { faq: String(index + 1), var: 'var3' });
